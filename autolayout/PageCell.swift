...
extension PageCell{
    private func addConstraints(){
        ...
        NSLayoutConstraint.activate([
            ...
            topImageViewContainer.leftAnchor.constraint(equalTo: contentView.leftAnchor),
            topImageViewContainer.rightAnchor.constraint(equalTo: contentView.rightAnchor),
            topImageViewContainer.heightAnchor.constraint(equalTo: contentView.heightAnchor, multiplier: 0.5)
